...
int main()
{
    GroupedRule one(Protocol::tcp, 80,80,80,80,196,44,24,50,500,Direction::in,Action::accept);
...
//	admin.addRule(one);
	...
	if(admin.ruleAllowed(usern, password, one))
	{
		cout<<"Your rule was allowable"<<endl;
	}
	else
	{
		cout<<"Your rule was denied"<<endl;
	}
